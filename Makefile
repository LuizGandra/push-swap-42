...
INCLUDES := -I$(INCLUDE_DIR) -I$(LIBFT_DIR)/$(INCLUDE_DIR) -I$(LIBFT_DIR)/ft_printf/$(INCLUDE_DIR)
INCLUDES_BONUS := -I$(INCLUDE_DIR_BONUS) -I$(LIBFT_DIR)/$(INCLUDE_DIR) -I$(LIBFT_DIR)/ft_printf/$(INCLUDE_DIR)
